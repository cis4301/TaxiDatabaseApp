...
#    results = Geocoder('AIzaSyBHIDOmlFDBhq3ERfSMqJ321GuYxUgpmdM').reverse_geocode(data['pickup_latitude'][0], data['pickup_longitude'][0])
#    print(results)
    results = Geocoder('AIzaSyBHIDOmlFDBhq3ERfSMqJ321GuYxUgpmdM').geocode(data['pickup_latitude'][100], data['pickup_longitude'][100])
    print(results)
