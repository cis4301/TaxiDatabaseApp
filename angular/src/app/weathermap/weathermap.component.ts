...
export class WeathermapComponent implements OnInit {
  ...
  async setTemp()  {
        ...
        this.dataService.getTempMap(temp).subscribe((res:Response) => {
        data = res;
        console.log(data);
         });
         while(!data) {
             ...
             for (var i  in data) {
               if (id === data[i].ZONE) {
                 ...
                 if (data[i].DIFF > 0) {
                   ...
                   mappers.data.overrideStyle(feature, {fillColor: '#fff2af', strokeWeight: 1, fillOpacity: 1, strokeColor: 'black', strokeOpacity: 1});
                 } else {
