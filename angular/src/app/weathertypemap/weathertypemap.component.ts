...
@Component({
  selector: 'app-weathertypemap',
  templateUrl: './weathertypemap.component.html',
  styleUrls: ['./weathertypemap.component.css']
})

export class WeathertypemapComponent implements OnInit {
  ...
  async setType(weathertype)  {
        ...
        this.dataService.getTypeMap(weathertype).subscribe((res:Response) => {
        data = res;
        console.log(data);
         });
         while(!data) {
